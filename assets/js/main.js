...
function mostrarEnCarrusel({ noticias }) {
    ...
    noticias.forEach((elemento, index) => {
        if (index == 0) {
            ...
            <img src="${elemento.imagenes[0]}" class="d-block w-100 h-50" id="carousel-image" alt="...">
            <div class="carousel-caption  d-md-block fondo-fuente-carrusel rounded" id="carousel-description">
                    <h5 id="title-description-carousel">${elemento.titulo}</h5>
                    <p id="subtitle-description-carousel">${elemento.subtitulo}</p>
                </div>
            </div>`;
